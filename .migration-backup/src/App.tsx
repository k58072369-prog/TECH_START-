...
import { AlertCircle, Sliders, Globe, RefreshCcw, Home, Sparkles } from 'lucide-react';
...
export default function App() {
  ...
  // Sync route State with popstate (browser back/forward arrows)
  useEffect(() => {
  ...
  // Sync index Metadata SEO on path change
  useEffect(() => {
    if (route.path === 'home') {
  ...
  // Fetch article detailed view when path matching
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-[#0f172a] flex flex-col justify-between selection:bg-blue-500/10 selection:text-blue-900">
      ...
      {/* Dynamic Top Layer Navigation */}
      <Navbar currentRoute={route} onNavigate={handleNavigate} />

      {/* Main Animated Routing Frame */}
        ...
        <AnimatePresence mode="wait">
          ...
          {loading && route.path !== 'admin' ? (
            ...
            >
              ...
              <h2 className="font-display text-xl font-bold text-[#0f172a] mb-2 font-display">عقبة تقنية بالقاعدة السحابية</h2>
